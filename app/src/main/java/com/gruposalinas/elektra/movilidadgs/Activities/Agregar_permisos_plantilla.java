...
//        bloquearPantalla.bloquear(this);
    ...
    public  class fechas extends DialogFragment implements DatePickerDialog.OnDateSetListener {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new DatePickerDialog(getActivity(), THEME_HOLO_LIGHT,this, year, month, day);
    ...
    public void exito(Permisos permisos)
    {
        ...
        if(permisos.isSuccess())
        {
            ...
            alertas.displayMensaje(getString(R.string.Error_Conexion),Agregar_permisos_plantilla.this);
        }
    ...
    private void Validar_fecha_horarios()
    {
        ...
        try {
            ...
            if(date2.after(date1) || date2.equals(date1))
            {
              ...
              //  Toast.makeText(getApplicationContext(),"fecha corerctoa1",Toast.LENGTH_SHORT).show();
                fecha1= true;
            }
            else {
                fecha1=false;
            ...
            if(date.after(date1) || date.equals(date1))
            {
             ...
             //   Toast.makeText(getApplicationContext(),"fecha corerctoa2",Toast.LENGTH_SHORT).show();
            ...
            if(date2.after(date) || date2.equals(date1))
            {
                validar_fechas= true;
            }
    ...
    public void enviar_permiso()
    {
        ...
        {
            alertas.displayMensaje("La Hora de fin del permiso debe ser posterior a la hora de  inicio",this);
        }
        if(!fecha1 || !fecha2)
        {
            alertas.displayMensaje("La fecha de fin del permiso debe ser posterior o igual a la de inicio",this);
