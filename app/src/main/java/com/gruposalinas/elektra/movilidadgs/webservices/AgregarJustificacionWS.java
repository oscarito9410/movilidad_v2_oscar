...
{
    public static String TAG = "AgregarJustificacion";
    String line=null;
    ...
    public Incidencias incidencias(Incidencias incidencias)
    {
     ...
     //String URL="http://200.38.122.208:8081/ServicioEmpleados.svc/AgregarJustificacion";
        ...
        SecurityItems securityItemsJustifica=new SecurityItems(incidencias.getD_num_empleado_justifica());
        //NÚMERO DE EMPLEADO QUE SE JUSTIFIACARÁ LA INCIDENCIA
        SecurityItems securityItemsEmpleadoJustificar=new SecurityItems(incidencias.getNumero_empleado());
        JSONObject a= new JSONObject();
        try {
            a.put("token",securityItemsJustifica.getTokenEncrypt());
            a.put("id_num_empleado",securityItemsJustifica.getIdEmployEncrypt());
            a.put("id_csc_incid", incidencias.getCSCINCD());
            a.put("id_justificacion",incidencias.getId_justificacion());
            a.put("id_num_empleado_justifica",securityItemsEmpleadoJustificar.getIdEmployEncrypt());
            ...
            Log.d(TAG, "inicia agregar_incidencia " + a.toString());
